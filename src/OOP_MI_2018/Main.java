public class Main {
    ...
    public static void main(String[] args) {
        Musician m1 = new Musician("Dave Grohl", "USA", 50, BandPosition.SINGER, 98);
        Musician m2 = new Musician("Pat Smear", "USA", 59, BandPosition.GUITARIST, 85);
        Musician m3 = new Musician("Chris Shiflett", "USA", 47, BandPosition.GUITARIST, 85);
        Musician m4 = new Musician("Nate Mendel", "USA", 50, BandPosition.BASSIST, 93);
        Musician m5 = new Musician("Taylor Hawkins", "USA", 47, BandPosition.SINGER, 70);
        Musician m6 = new Musician("Rami Jaffee", "USA", 50, BandPosition.PIANIST, 72);
